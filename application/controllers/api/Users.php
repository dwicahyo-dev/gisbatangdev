...
class Users extends Restdata {
	...
	public function register_post()
	{
		...
		if($this->User_model->check_username($username)){
			return $this->badreq('Username Anda Sudah Terdaftar, Silahkan Gunakan Username Lain');
		}else{
			$data['username'] = $username;
		}

		$this->form_validation->set_rules('email','E-Mail','trim|max_length[255]|required');
